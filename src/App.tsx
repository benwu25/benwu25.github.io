  ...
  if (isMobile) {
    return (
      <div>
        ...
        <div>
          <b className="ml-[3%] text-[30px]">Ben Wu</b>
        </div>

        <div>
          <a className="underline ml-[3.2%] text-[12px]" href="mailto:bwu25@cs.washington.edu">Email</a>
        </div>
        <div>
          <a className="underline ml-[3.2%] text-[12px]" href="https://www.linkedin.com/in/benwu25">LinkedIn</a>
        </div>
        <div>
          <a className="underline ml-[3.2%] text-[12px]" href="https://github.com/benwu25">GitHub</a>
        </div>
        ...
        <div>
          <b className="text-[15px] ml-[3.85%]">About:</b>
        </div>

        <div className="max-w-180 text-[10px] ml-[3.85%]">
        ...
        <div>
          <Link className="underline ml-[3.85%] text-[12px]" to="/contributions">Open source contributions</Link>
        </div>
